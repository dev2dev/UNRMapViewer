...
@synthesize vbo = vbo_, vertCount = vertCount_, tex = tex_, front = front_, back = back_, coPlanar = coPlanar_, surfFlags = surfFlags_, shader = shader_, lightMap = lightMap_, strideLength = strideLength_;
